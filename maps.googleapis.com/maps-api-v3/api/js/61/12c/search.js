google.maps.__gjsload__('search', function(_) {
    var jsa = function(a) {
        ...
        isa = function(a) {
            ...
            const d = [];
            a.hv().forEach(e => {
                e.a && e.a.length >= 2 && d.push(new ksa(e, b, c))
            });
            return d
        },
        lsa = class extends _.bn {};
    var msa = {
            ["1"]: {}
        },
        ksa = class {
            ...
            getAnchor() {
                if (!this.anchor) {
                    const a = 1 << this.zoom;
                    this.anchor = _.ks(new _.Pq((this.xn.x * 256 + this.source.a[0]) / a, (this.xn.y * 256 + this.source.a[1]) / a)).toJSON()
                }
                return this.anchor
            }
            getCompleteBounds() {
                    ...
                    if (!nsa.has(a)) {
                        ...
                        var c = [],
                            ...
                            e = () => {
                                ...
                                b.forEach(f => {
                                    if (f = f.data) c.push(_.Im(f, "insert", g => {
                                        d(g, "addfeatures")
                                    })), c.push(_.Im(f, "remove", g => {
                                        d(g, "removefeatures")
                                    }))
                                })
                            };
                        ...
                        f.length && _.Ym(a, "addfeatures", f)
                    })()
                }
            }
        };
    WH.enableFeatureMapEventsRasterOnly = WH.enableFeatureMapEventsRasterOnly;
    _.Fn(WH.prototype, {
        map: _.au
    });
    _.oa.google.maps.search = {
        GoogleLayer: WH
    };
    _.Yk("search", {});
});